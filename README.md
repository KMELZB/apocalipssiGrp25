...
## Tests upload et génération de quiz

L’endpoint de génération de quiz accepte deux types de contenu :

* un fichier PDF ;
* un texte direct via `source_text`.

Règles de validation :

* le texte doit contenir au moins 200 caractères ;
* seuls les fichiers `.pdf` sont acceptés ;
* l’utilisateur doit être authentifié pour générer un quiz.

Tests ajoutés :

* refus d’un texte trop court ;
* refus d’un fichier non PDF ;
* vérification de la génération de quiz en mode mock.
...
* * � q u i p e   : * *   M a z e n   R A D I ,   Y o n i   D E S E R B A I X ,   M e l v y n   B L A N C H I ,   R i z l � n e   B E R R A G ,   A n a s s   H O U D Z I ,   T a h i n a   H O N I   R I K A 
 
 