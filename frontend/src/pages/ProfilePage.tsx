...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {/* Zone RGPD : export données (J3-bis — Art. 15 droit à la portabilité) */}
      <section className="card">
        <h2 className="text-lg font-semibold text-slate-900 mb-2">Mes données (RGPD)</h2>
        <p className="text-sm text-slate-600 mb-4">
          Téléchargez toutes vos données personnelles conformément à l'Art. 15 RGPD.
        </p>
        {exportErr && (
          <div className="mb-4 p-3 bg-rose-50 border-l-4 border-rose-500 text-sm text-rose-900 rounded">
            {exportErr}
